...
// SharedLinkEndpoint is an autogenerated mock type for the SharedLinkEndpoint type
type SharedLinkEndpoint struct {
	mock.Mock
}

// Create provides a mock function with given fields: c
func (_m *SharedLinkEndpoint) Create(c *gin.Context) {
	_m.Called(c)
}

// Delete provides a mock function with given fields: c
func (_m *SharedLinkEndpoint) Delete(c *gin.Context) {
	_m.Called(c)
}

// GetCommonMiddlewares provides a mock function with no fields
func (_m *SharedLinkEndpoint) GetCommonMiddlewares() []gin.HandlerFunc {
	ret := _m.Called()
...
func (_m *SharedLinkEndpoint) GetEndpointName() string {
	ret := _m.Called()
...
func (_m *SharedLinkEndpoint) GetEndpointsList() map[common.MethodPath][]gin.HandlerFunc {
	ret := _m.Called()
...
func (_m *SharedLinkEndpoint) GetGroupUrl() string {
	ret := _m.Called()
...
func (_m *SharedLinkEndpoint) GetPermissionsManager() common.PermissionsManager {
	ret := _m.Called()
...
func (_m *SharedLinkEndpoint) List(c *gin.Context) {
	_m.Called(c)
}

// Update provides a mock function with given fields: c
func (_m *SharedLinkEndpoint) Update(c *gin.Context) {
	_m.Called(c)
}

// NewSharedLinkEndpoint creates a new instance of SharedLinkEndpoint. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewSharedLinkEndpoint(t interface {
	mock.TestingT
	Cleanup(func())
}) *SharedLinkEndpoint {
	mock := &SharedLinkEndpoint{}
	mock.Mock.Test(t)
